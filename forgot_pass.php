...
<div class="signin-form">
    <form action="" method="post">
		...
		<div class="form-group">
        	...
        	<input type="text" class="form-control" placeholder="ShiningStar" name="name" autocomplete="off" required="required">
        </div>
        <div class="form-group">
	...
	<div class="text-center small" style='color:#67428B;'>Back to signin?<a href="log_in.php">Click here</a></div>
</div>
</body>
</html>
<?php 
...
$con = mysqli_connect("localhost","root","","demo1");
	...
	$select_user = "select * from users where User_name='$name' AND forgotten_answer='$recovery_account'";
	...
	echo "<script>alert('Your Username or your Bestfriend name is Incorrect')</script>";
