    ...
    <form action="" method="post" enctype="multipart/form-data">
          <table class="table table-bordered table-hover">
            ...
            <tr>
              ...
              <td>
              <button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal">Recovery Answer</button>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <pre >Answer the above question we will ask you this question if you forgot your password.
                      </pre>
                      <br><br>
                      </form>
                      <?php
                      if(isset($_POST['sub'])){
                        ...
                        $update = "update users set forgotten_answer='$bfn' where User_name='$user'";
              
                        $run = mysqli_query($con,$update);
                        
                        if($run){
                        
                        echo "<script>alert('Recovery Answer Updated')</script>";
                        echo "<script>window.open('account_settings.php?','_self')</script>";
                        }else{
        ...
        <?php
          ...
          $update = "update users set User_email='$email',user_gender='$u_gender' where User_name='$user'";
